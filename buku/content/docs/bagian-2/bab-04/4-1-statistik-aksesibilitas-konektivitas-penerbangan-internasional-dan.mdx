...
<VisualMenyusul tipe="Grafik" id="4.1" deskripsi="Diagram batang horizontal, perbandingan jumlah destinasi internasional langsung dari 5 bandara utama Indonesia (CGK, DPS, SUB, KNO, UPG) 2024; sumbu X: jumlah destinasi" sumber="masing-masing operator bandara, diolah" />

<VisualMenyusul tipe="Tabel" id="4.1" deskripsi="Statistik konektivitas udara 5 bandara utama Indonesia 2024; kolom: bandara, total penumpang (juta/tahun), destinasi internasional langsung, frekuensi weekly, kapasitas seat internasional (ribu/minggu)" sumber="AP II, AP I, operator bandara" />
