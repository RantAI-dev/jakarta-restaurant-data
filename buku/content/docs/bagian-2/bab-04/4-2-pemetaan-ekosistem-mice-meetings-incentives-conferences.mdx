...
- **Jumlah event internasional per tahun**: definisi "internasional" beragam, bisa *event* dengan peserta dari 5+ negara, atau *event* dengan peserta minimal 1.000 orangdengan minimal 30% partisipan internasional.
...
<VisualMenyusul tipe="Grafik" id="4.2" deskripsi="Diagram batang, Jumlah event MICE internasional yang diselenggarakan 5 kota utama Indonesia 2019–2024; sumbu X: tahun; sumbu Y: jumlah event; seri terpisah per kota" sumber="ICCA, Asosiasi Industri Pertemuan Indonesia (AIPI), diolah" />

<VisualMenyusul tipe="Tabel" id="4.2" deskripsi="Top-10 venue MICE Indonesia 2024; kolom: nama venue, kota, kapasitas (orang), tahun operasional, jumlah event internasional 2024" sumber="AIPI, direktori venue" />
