...
<GambarBuku tipe="Tabel" id="4.3" src="/figures/tabel-4.3-tpkh-provinsi.png" lebar={1400} tinggi={900} alt="Diagram batang horizontal, TPK hotel bintang tertinggi nasional Agustus 2024 (tiga provinsi teratas + rata-rata nasional sebagai pembanding); TPKH bintang dan nonbintang per provinsi ternyata berasal dari ranking provinsi yang berbeda pada periode yang sama sehingga tidak bisa disatukan dalam satu tabel tanpa mencampur sumber, dan jumlah hotel/kamar bintang per provinsi 2024 tidak ditemukan dalam format yang bisa diakses; sumber: BPS, dikutip Databoks/Tirto, 1 Oktober 2024" />
