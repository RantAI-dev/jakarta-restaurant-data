...
- **MPD**: memungkinkan rekonstruksi matriks asal_kota_asal × tujuan_kota secara langsung, dengan granularitas waktu dan rute perjalanan, tetapi dengan biasabilitas terhadap pengguna *smartphone*.
...
<VisualMenyusul tipe="Tabel" id="3.2" deskripsi="Matriks OD sederhana, kunjungan wisman per negara asal per pintu masuk utama 2024 (juta kunjungan); kolom: Soekarno-Hatta, Ngurah Rai, Juanda, Kualanamu, Hasanuddin, lain; baris: 10 negara asal teratas" sumber="BPS, diolah dari Statistik Kunjungan Wisman 2024" />

<VisualMenyusul tipe="Grafik" id="3.2" deskripsi="Peta panas Indonesia, distribusi spasial kunjungan wisman per pintu masuk 2024 (juta kunjungan)" sumber="BPS, diolah" />
