...
<GambarBuku tipe="Tabel" id="7.2" src="/figures/tabel-7.2-matriks-skenario.png" lebar={1920} tinggi={632} alt="Matriks skenario, 4 skenario kebijakan (status quo, investasi museum, peningkatan konektivitas, paket lengkap) dan dampaknya terhadap skor GCI, peringkat, serta biaya estimasi; sumber: simulasi, diolah" />
...
<GambarBuku tipe="Grafik" id="7.4" src="/figures/grafik-7.4-tornado-gci.png" lebar={1440} tinggi={880} alt="Tornado chart, sensitivity analysis skor GCI terhadap perubahan 10% pada tiap variabel; sumbu X: delta skor; sumbu vertikal: nama variabel; sumber: simulasi dengan formula GCI, diolah" />
