...
<GambarBuku tipe="Grafik" id="7.1" src="/figures/grafik-7.1-dampak-ekonomi.png" lebar={3136} tinggi={696} alt="Diagram alir, alur analisis dampak ekonomi pariwisata dari data belanja wisman ke estimasi multiplier dan kontribusi PDRB; sumber: kerangka teoretis, diolah" />
...
<GambarBuku tipe="Tabel" id="7.1" src="/figures/tabel-7.1-io-ringkas.png" lebar={1920} tinggi={816} alt="Tabel I-O ringkas Bali 2016 — keterkaitan ke belakang/ke depan (backward/forward linkage) 2 sektor karakteristik pariwisata (Penyediaan Akomodasi &amp; Makan Minum, Transportasi &amp; Pergudangan) vs 2 sektor kunci non-pariwisata sebagai pembanding, plus dampak riil simulasi kenaikan permintaan wisman; sumber: Tjandra &amp; Fevriera (Bina Ekonomi UKSW), data Tabel I-O Provinsi Bali 2016 (BPS), diolah. Cakupan disesuaikan dari rencana awal (kota besar Indonesia, 4 sektor akomodasi/F&amp;B/transport/hiburan terpisah): klasifikasi 10-sektor I-O yang tersedia riil hanya mencakup Bali, menggabungkan akomodasi &amp; F&amp;B jadi satu sektor, dan tidak punya sektor hiburan tersendiri." />
