...
Panjang ideal: 4–6 halaman, sering dengan infografis di halaman pertama untuk perhatian cepat.
...
<VisualMenyusul tipe="Tabel" id="8.1" deskripsi="Kerangka policy brief, 6 bagian dengan panjang dan tujuan masing-masing" sumber="best practice adaptasi dari UN/World Bank, diolah" />

<VisualMenyusul tipe="Grafik" id="8.2" deskripsi="Diagram alir, proses penyusunan policy brief dari data mentah hingga rekomendasi final" sumber="kerangka teoretis, diolah" />
