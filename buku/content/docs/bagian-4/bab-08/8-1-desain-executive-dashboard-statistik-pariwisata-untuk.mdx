...
<GambarBuku tipe="Grafik" id="8.1" src="/figures/grafik-8.1-dashboard-wireframe.png" lebar={3200} tinggi={1786} alt="Mockup dashboard eksekutif, wireframe layout dengan 4 zona: KPI, tren, distribusi asal, peta; sumber: ilustrasi, diolah" />
