...
<VisualMenyusul tipe="Grafik" id="8.3" deskripsi="Roadmap 10 tahun, milestone perbaikan peringkat GCI Jakarta per tahun, dengan skenario pesimistis (garis merah), realistis (garis tengah), dan optimistis (garis atas)" sumber="model skenario, diolah" />

<VisualMenyusul tipe="Tabel" id="8.2" deskripsi="Anggaran estimasi per pilar (dalam USD juta) untuk strategi 10 tahun Jakarta Top 50; kolom: pilar, tahun 1–2, tahun 3–5, tahun 6–10, total, sumber pendanaan utama" sumber="studi kelayakan, diolah" />
