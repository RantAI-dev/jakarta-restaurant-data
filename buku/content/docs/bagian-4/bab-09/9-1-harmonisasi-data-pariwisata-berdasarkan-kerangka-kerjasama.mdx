...
<GambarBuku tipe="Grafik" id="9.1" src="/figures/grafik-9.1-harmonisasi-sdi.png" lebar={3136} tinggi={1048} alt="Diagram alir, alur harmonisasi data SDI: dari produsen data (BPS, Disparekraf, operator) ke metadata, standar, dan interoperabilitas; sumber: kerangka SDI, diolah" />
