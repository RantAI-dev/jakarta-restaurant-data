...
<GambarBuku tipe="Grafik" id="9.4" src="/figures/grafik-9.4-pipeline-crawling-llm.png" lebar={3136} tinggi={320} alt="Diagram pipeline, dari crawling ke visualization dengan LLM sebagai middleware; sumber: kerangka pipeline AI, diolah" />
