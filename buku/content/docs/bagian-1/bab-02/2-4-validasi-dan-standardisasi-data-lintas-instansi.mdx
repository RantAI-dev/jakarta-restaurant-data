...
<GambarBuku tipe="Grafik" id="2.4" src="/gambar/grafik-2.4-kategori-event.svg" lebar={1200} tinggi={662} alt="Sepuluh nilai jenis event terbanyak pada katalog event Dinas Pariwisata; lima ejaan berbeda merujuk kategori musik yang sama." />
