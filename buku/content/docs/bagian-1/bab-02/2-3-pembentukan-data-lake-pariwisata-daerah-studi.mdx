...
<GambarBuku tipe="Grafik" id="2.2" src="/gambar/grafik-2.2-lapisan-data-lake.svg" lebar={1200} tinggi={460} alt="Lapisan data lake pariwisata daerah dari zona mentah ke data mart, dengan tata kelola Satu Data Indonesia yang melingkupinya." />
