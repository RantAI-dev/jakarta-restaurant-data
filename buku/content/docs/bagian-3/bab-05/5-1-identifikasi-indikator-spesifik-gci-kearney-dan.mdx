...
<GambarBuku tipe="Tabel" id="5.1" src="/figures/tabel-5.1-perbandingan-indeks.png" lebar={1840} tinggi={996} alt="Perbandingan struktur tiga indeks kota utama (Kearney GCI, GPCI Mori, Resonance); kolom: nama indeks, jumlah dimensi, jumlah variabel, fokus utama, metode pengumpulan data, keterbukaan metodologis; sumber: laporan metodologi masing-masing indeks" />
