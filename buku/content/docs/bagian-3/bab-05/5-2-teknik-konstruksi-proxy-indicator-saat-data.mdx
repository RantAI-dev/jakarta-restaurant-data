...
<VisualMenyusul tipe="Tabel" id="5.2" deskripsi="Contoh pemetaan variabel GCI/GPCI ke proxy Indonesia untuk konteks kota besar; kolom: variabel asli, sumber asli, proxy yang dipakai, sumber proxy, keterbatasan; baris: 10 variabel kunci" sumber="BPS, AIPI, PHRI, diolah" />
