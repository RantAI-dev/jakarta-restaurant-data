...
<GambarBuku tipe="Grafik" id="5.1" src="/figures/grafik-5.1-normalisasi.png" lebar={1440} tinggi={1500} alt="Ilustrasi perbandingan metode normalisasi (baris subplot: min-max, z-score, rank-based) untuk 5 kota hipotetis; sumbu X: kota; sumbu Y: skor ternormalisasi; seri: variabel museum, variabel konektivitas, variabel pengeluaran; sumber: ilustrasi, diolah" />
