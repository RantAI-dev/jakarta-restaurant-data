...
<GambarBuku tipe="Tabel" id="5.3" src="/figures/tabel-5.3-ahp-vs-pca.png" lebar={1440} tinggi={852} alt="Perbandingan AHP vs PCA untuk pembobotan indeks; kolom: aspek, AHP, PCA; baris: pendekatan, kebutuhan data, interpretabilitas, subjektivitas, kompleksitas, aplikasi; sumber: kerangka teoretis, diolah" />
...
<GambarBuku tipe="Grafik" id="5.2" src="/figures/grafik-5.2-pembangunan-indeks.png" lebar={3136} tinggi={324} alt="Diagram alir, proses pembangunan indeks kota dari identifikasi variabel hingga validasi akhir; sumber: kerangka teoretis, diolah" />
