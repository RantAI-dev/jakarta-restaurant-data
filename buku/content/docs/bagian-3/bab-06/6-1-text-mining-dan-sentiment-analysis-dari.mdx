...
<GambarBuku tipe="Grafik" id="6.1" src="/gambar/grafik-6.1-pipeline-text-mining.svg" lebar={1200} tinggi={574} alt="Enam langkah pra-pemrosesan ulasan daring, dari teks mentah sampai siap diberi skor sentimen." />
...
<GambarBuku tipe="Grafik" id="6.2" src="/gambar/grafik-6.2-volume-ulasan.svg" lebar={1200} tinggi={558} alt="Sebaran jumlah ulasan per venue untuk restoran, nightlife, dan toko suvenir Jakarta pada sumbu logaritmik, dengan median masing-masing kategori." />
