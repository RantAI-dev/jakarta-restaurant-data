...
<GambarBuku tipe="Grafik" id="6.3" src="/figures/grafik-6.3-nps-distribusi.png" lebar={1400} tinggi={900} alt="Diagram batang, distribusi skor NPS (0–10) untuk kota X 2024; sumbu X: skor; sumbu Y: proporsi responden (%); seri terpisah untuk promoter (9–10), passive (7–8), detractor (0–6); sumber: survei lapangan, diolah" />
...
<GambarBuku tipe="Tabel" id="6.3" src="/figures/tabel-6.3-nps-driver.png" lebar={1400} tinggi={900} alt="Top-10 driver NPS kota 2024; kolom: driver, kategori aspek, korelasi dengan skor keseluruhan (korelasi Spearman), signifikansi; sumber: analisis regresi survei NPS, diolah" />
